...
import { FiLogOut, FiCalendar, FiUser, FiPhone, FiMail, FiUsers } from 'react-icons/fi';
      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-gray-900">
            <span className="text-orange-500">Staff</span> Dashboard
          </h1>
          <button
...
const StatusBadge = ({ status }) => {
  ...
  const currentStatus = statusMap[status?.toLowerCase()] || { color: 'yellow', text: 'Pending' };
